...
export const updateCommunityPost = (postId, payload) => http.patch(`/api/v1/community/posts/${postId}`, payload)
export const deleteCommunityPost = (postId) => http.delete(`/api/v1/community/posts/${postId}`)
export const toggleCommunityScrap = (postId) => http.post(`/api/v1/community/posts/${postId}/scrap`)
export const getScrappedCommunityPosts = () => http.get('/api/v1/community/posts/scraps')
